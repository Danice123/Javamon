...
public abstract class PokedexPage extends Screen {
	...
	public static PokedexPage newMenu(Game game, Screen parent, Pokemon pokemon) {
		try {
			return (PokedexPage) pokedexPageMenuClass.getConstructors()[0].newInstance(game, parent, pokemon);
